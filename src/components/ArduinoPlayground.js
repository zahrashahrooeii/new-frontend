...
const ArduinoPlayground = () => {
  ...
  const [code, setCode] = useState(""); // Arduino code state
  ...
  // Run Arduino code (placeholder)
  const handleRun = () => {
    alert("Run functionality is triggered. This is a placeholder for running the Arduino code.");
  };
      ...
      <div className="flex flex-col w-full lg:w-[50%] gap-2">
        ...
        {activePanel === "code" ? (
          <>
            {/* Arduino Code Panel */}
            <div className="mb-1">
              <h2 className="text-lg font-bold text-[#000000]">Arduino Code</h2>
              <textarea
          ...
          <>
            ...
            <div className="mb-1">
              <h2 className="text-lg font-bold text-[#000000]">
                Arduino Code Modifier
              </h2>
              <textarea
                className="border w-full h-[220px] rounded-md p-2 text-sm bg-white"
                placeholder="Modify your Arduino code here..."
                value={code}
                onChange={(e) => setCode(e.target.value)}
                style={{
                  resize: "none",
